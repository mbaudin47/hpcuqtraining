...
\alert{Dans le cas de composantes $X_i$ ind\'ependantes, ces indices sont des indices de Sobol.}
 ...
 \begin{block}{Si le modèle $f$ est lin\'eaire par rapport aux $X_i$ : SRC}
...
\begin{block}{Si le modèle $f$ est lin\'eaire par rapport aux $X_i$ : Pearson}
...
\frametitle{Mesures historiques}
 ...
 \begin{block}{Si le modèle $rang(f)$ est  lin\'eaire par rapport aux $rang(X_i)$: SRRC}
 ...
 \begin{block}{Si le modèle $rang(f)$ est  lin\'eaire par rapport aux $rang(X_i)$: Spearman}
