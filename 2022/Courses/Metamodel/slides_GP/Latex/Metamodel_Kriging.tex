...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.5\linewidth]{krig_step_1.png}&
\includegraphics[width=0.5\linewidth]{var_step_1.png}
\end{tabular}
...
\begin{tabular}{cc}
\includegraphics[width=0.5\linewidth]{krig_step_2.png} &
\includegraphics[width=0.5\linewidth]{var_step_2.png}
\end{tabular}
...
\begin{tabular}{cc}
\includegraphics[width=0.5\linewidth]{krig_step_3.png}&
\includegraphics[width=0.5\linewidth]{var_step_3.png}
\end{tabular}
...
\begin{tabular}{cc}
\includegraphics[width=0.5\linewidth]{krig_step_4.png} &
\includegraphics[width=0.5\linewidth]{var_step_4.png}
\end{tabular}
...
\begin{tabular}{cc}
\includegraphics[width=0.5\linewidth]{krig_step_5.png}&
\includegraphics[width=0.5\linewidth]{var_step_5.png}
\end{tabular}
